...
| Fichier | Pour |
|---|---|
| [`methode-palambur-prompt.md`](methode-palambur-prompt.md) | Version **complète** (~8 000 car.) — GPT personnalisé, Agent Mistral, AI Tools Infomaniak, Projet Claude |
| [`methode-palambur-prompt-court.md`](methode-palambur-prompt-court.md) | Version **courte** (~1 400 car.) — Gemini Gem, Instructions personnalisées ChatGPT |
...
2. Nom : `Méthode Palambur`. Coller la **version courte** dans les instructions (Google conseille 500–2 000 car.).
...
La **source canonique** de la méthode reste le skill Claude Code (`skills/palambur-method/`). Ces prompts en sont une **photographie condensée** : après une évolution du skill, les régénérer pour éviter la dérive.
